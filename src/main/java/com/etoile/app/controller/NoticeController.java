...
public class NoticeController {
	...
	@GetMapping("/list")
	public String getList(@RequestBody Map<String,String> req) {
...
//			m.addAttribute("NoticeTitle","공지사항 목록");
	...
	@GetMapping("/write")
	public String doWrite(@RequestBody Map<String,String> req, HttpSession s) {
...
//			m.addAttribute("NoticeTitle","공지사항 작성");
	...
	@PostMapping("/save")
	@ResponseBody
	public String doSave(@RequestBody Map<String,String> req,HttpSession s) {
		req.forEach((k, v) -> System.out.println(k + " [" + v+"]"));
	...
	@GetMapping("/view")
	public String doView(@RequestBody Map<String,String> req, HttpSession s) {
		req.forEach((k, v) -> System.out.println(k + " [" + v+"]"));
		try {
//			if(s.getAttribute("member_id")==null) {
//				return "redirect:/member/signin";
...
//			m.addAttribute("NoticeTitle","공지사항 변경");
	...
	@PostMapping("/delete")
	@ResponseBody
	public String doDelete(@RequestBody Map<String,String> req, HttpSession s) {
		req.forEach((k, v) -> System.out.println(k + " [" + v+"]"));
		JSONObject result = new JSONObject();
		result.put("errcode",Errata.error);
		result.put("data",null);
